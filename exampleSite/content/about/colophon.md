...
The primary font face is Open Sans and the monospace font face is Fira Mono. The social icons are from the Ionicons font set. CSS classes for code syntax highlighting are inserted during compile-time by Hugo using Pygments.
